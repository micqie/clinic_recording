...
class Conditions
{
    function getAll()
    {
        ...
        try {
            $stmt = $conn->prepare("SELECT * FROM tbl_conditions ORDER BY condition_name");
            $stmt->execute();
    ...
    function add($json)
    {
        ...
        try {
            ...
            $stmt = $conn->prepare("INSERT INTO tbl_conditions (condition_name) VALUES (:name)");
            $stmt->bindParam(":name", $name);
            $stmt->execute();
    ...
    function delete($id)
    {
        ...
        try {
            $stmt = $conn->prepare("DELETE FROM tbl_conditions WHERE condition_id = :id");
